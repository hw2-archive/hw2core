...
final class S_Enum {
    ...
    /**
     * D: enum with defines
     * @param Array $array MUST be of type "array" and MUST be passed
     * @param boolean $asBitwise MUST be of type "boolean" and OPTIONAL passage
     * @return boolean
     */
    public static function D(Array $array, $asBitwise = FALSE) {
    ...
    /**
     * Cn: enum with constants
     * @param string $base_class the name of typedef
     * @param Array $array MUST be of type "array" and MUST be passed
     * @return boolean
     */
    public static function Cn($base_class,Array $array) {
    ...
    /**
     * C: a function for generating type safe, iterable, singleton enumerations.
     *
     ...
     * @return nothing
     */
    public static function C($base_class, array $args) {
