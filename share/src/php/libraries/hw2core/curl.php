...
class S_Curl
{
	...
	public function post($url,$paramArr=array(),$returnsString=0,$url_encode=0)
	{
		...
		$return = $this->xml2array($cUrlResponse);
                // fix undefined index with array_key_exists [hw2]
		if(!is_array($return) || ( array_key_exists('result',$return) && $return['result']=='FAIL' ) || $httpResponseArr['http_code']!=200)
		{
