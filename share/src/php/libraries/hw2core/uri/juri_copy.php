...
// AFTER COPY CHANGE JUri to JUriCopy class name and all recurrences in file , and replace the access check at top of this file
...
class JUriCopy
{
	...
	public static function getInstance($uri = 'SERVER')
	{
		if (empty(self::$instances[$uri]))
		{
			...
			self::$instances[$uri] = new JUriCopy($theURI);
		}
